...
import { readUsersFile, writeUsersFile } from '../services/userService.js';
// const { sendSuccessResponse, sendErrorResponse} = require('../utils/sendResponseUtil');
import { sendSuccessResponse, sendErrorResponse} from '../utils/sendResponseUtil.js';
// const { searchPattern } = require('../utils/searchUtil');
import { searchPattern } from '../utils/searchUtil.js';
